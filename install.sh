...
sudo pacman -Syu
sudo pacman -Sy hyprland hyprpaper wofi nautilus alacritty waybar code chromium nerd-fonts starship p7zip jq neofetch pipewire pipewire-pulse pipewire-alsa wireplumber dolphin-emu nodejs npm intellij-idea-community-edition brightnessctl --noconfirm
